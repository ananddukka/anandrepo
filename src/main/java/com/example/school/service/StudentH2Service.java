...
@Override 
public Student addStudent(Studet student) {
    ...
    Students savedStudent = db.queryForObject("Select * from student where studentName = ? and Gender = ? and standard = ?", new StudentRowMapper(),
